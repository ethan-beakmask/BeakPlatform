...
DEFAULT_JOB_TITLES = [
    ...
    {'code': 'SR_CONSULT', 'name': '資深顧問', 'name_en': 'Senior Consultant', 'level': 'L800', 'family': 'GEN', 'is_supervisor': False},
    {'code': 'CONSULT', 'name': '顧問', 'name_en': 'Consultant', 'level': 'L800', 'family': 'GEN', 'is_supervisor': False},
    ...
    {'code': 'SR_SA', 'name': '資深特別助理', 'name_en': 'Senior Special Assistant', 'level': 'L700', 'family': 'GEN', 'is_supervisor': False},
    ...
    {'code': 'SA', 'name': '特別助理', 'name_en': 'Special Assistant', 'level': 'L600', 'family': 'GEN', 'is_supervisor': False},

    # L500 - 經理級
    {'code': 'MGR', 'name': '經理', 'name_en': 'Manager', 'level': 'L500', 'family': 'MGR', 'is_supervisor': True},
    {'code': 'PM', 'name': '專案經理', 'name_en': 'Project Manager', 'level': 'L500', 'family': 'GEN', 'is_supervisor': False},
    ...
    {'code': 'ASST_PM', 'name': '專案副理', 'name_en': 'Assistant Project Manager', 'level': 'L400', 'family': 'GEN', 'is_supervisor': False},
    ...
    {'code': 'PL', 'name': '專案主任', 'name_en': 'Project Leader', 'level': 'L300', 'family': 'GEN', 'is_supervisor': False},
    {'code': 'PRIN_ENG', 'name': '主任工程師', 'name_en': 'Principal Engineer', 'level': 'L300', 'family': 'TECH', 'is_supervisor': False},

    # L200 - 高級職員級
    {'code': 'SR_SPEC', 'name': '高級專員', 'name_en': 'Senior Specialist', 'level': 'L200', 'family': 'GEN', 'is_supervisor': False},
    ...
    # L100 - 職員級
    {'code': 'SPEC', 'name': '專員', 'name_en': 'Specialist', 'level': 'L100', 'family': 'GEN', 'is_supervisor': False},
    ...
    # L000 - 外部廠商
    {'code': 'CONTRACTOR', 'name': '約聘人員', 'name_en': 'Contractor', 'level': 'L000', 'family': 'GEN', 'is_supervisor': False},
    {'code': 'INTERN', 'name': '實習生', 'name_en': 'Intern', 'level': 'L000', 'family': 'GEN', 'is_supervisor': False},
    {'code': 'VENDOR', 'name': '廠商代表', 'name_en': 'Vendor Representative', 'level': 'L000', 'family': 'GEN', 'is_supervisor': False},
]
