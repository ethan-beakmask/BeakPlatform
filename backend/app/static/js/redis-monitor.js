...
function redisMonitor() {
    return {
        ...
        loadInfo: function() {
            var self = this;
            self.loading = true;
            fetch(window.__BP + '/server-manage/api/redis/info')
        ...
        scanKeys: function(reset) {
            ...
            fetch(window.__BP + '/server-manage/api/redis/keys?' + params.toString())
                .then(function(r) { return r.json(); })
                .then(function(data) {
                    if (data.ok) {
        ...
        viewKey: function(keyName) {
            ...
            fetch(window.__BP + '/server-manage/api/redis/key/' + encodeURIComponent(keyName) + '?' + params.toString())
                .then(function(r) { return r.json(); })
                .then(function(data) {
                    if (data.ok) {
                        self.keyDetail = data;
        ...
        loadSlowlog: function() {
            ...
            fetch(window.__BP + '/server-manage/api/redis/slowlog')
                .then(function(r) { return r.json(); })
                .then(function(data) {
                    if (data.ok) {
