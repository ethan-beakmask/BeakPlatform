...
派工時**併同貼上**：`dev-notes/codex_spec/portal.md`、`security.md`、`frontend.md`、
...
改 `file_service.py` 的三張常數表時，同步檢查 `dev-notes/FILE_SERVICE.md`
...
- **manifest 是 `dev-notes/manifests/mod-nocode-builder.yaml`**
