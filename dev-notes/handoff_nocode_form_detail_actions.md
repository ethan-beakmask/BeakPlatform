...
> 建立日期：2026-07-29
> 前置交接檔：`dev-notes/handoff_nocode_n1_n5.md`（N1~N5 的判定鏈、檔案地圖、十個踩坑）
...
第一個 action 落地時要補 E2E（`dev-notes/handoff_nocode_n1_n5.md` §6.8 登記在案）。
...
1. `dev-notes/handoff_nocode_n1_n5.md` **§2 三層判定鏈**
   —— read 未宣告放行 / write 未宣告拒絕，語意刻意不同
2. `dev-notes/handoff_nocode_n1_n5.md` **§4 踩過的坑**
