...
### ⚠️ 待處理項目
1. ~~**ACE 錯誤調查**~~ ✅ 已解決（2026-02-07）
2. ~~**新建時產生空白檔案**~~ ✅ 已解決（2026-02-07）
3. ~~**流程自動建立對應表單**~~ ✅ 保留現況，已在配對頁面加入說明按鈕（2026-02-07）
4. ~~**CI/CD 安全檢查移轉**~~ ✅ 已完成（2026-02-07）— semgrep 規則 + Forgejo Actions workflow + bandit + security_scan.sh
