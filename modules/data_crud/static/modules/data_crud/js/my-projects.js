...
function myProjectsManager() {
    return {
        ...
        async loadList() {
            this.loading = true;
            try {
                const res = await fetch('/api/data-crud/projects');
        ...
        async togglePublish(item) {
            ...
            try {
                const res = await fetch('/api/data-crud/projects/' + item.secure_code + '/' + action, {
                    method: 'POST',
                });
                const data = await res.json();
                if (data.success) {
        ...
        async doDelete() {
            ...
            try {
                const res = await fetch('/api/data-crud/projects/' + this.deletingItem.secure_code, {
                    method: 'DELETE',
                });
                const data = await res.json();
                if (data.success) {
