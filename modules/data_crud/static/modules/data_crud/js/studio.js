...
function studioManager() {
    ...
    return {
        ...
        async _loadSubSystem() {
            try {
                const res = await fetch('/api/data-crud/sub-systems/' + this.subSystemSc);
        ...
        async _loadTree() {
            try {
                const res = await fetch('/api/data-crud/sub-systems/' + this.subSystemSc + '/site-map');
                const data = await res.json();
                if (data.success) {
                    this.tree = data.data || [];
                }
        ...
        async _loadPageLayout(pageSc) {
            try {
                const res = await fetch('/api/data-crud/pages/' + pageSc);
                const data = await res.json();
                if (data.success) {
        ...
        async doAddNode() {
            ...
            try {
                ...
                if (this.addNodeForm.node_type === 'page') {
                    const pageRes = await fetch('/api/data-crud/pages', {
                        method: 'POST',
                ...
                const res = await fetch(
                    '/api/data-crud/sub-systems/' + this.subSystemSc + '/site-map/nodes',
                    {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
        ...
        async _saveReorder() {
            ...
            try {
                await fetch(
                    '/api/data-crud/sub-systems/' + this.subSystemSc + '/site-map/reorder',
                    {
                        method: 'PUT',
                        headers: { 'Content-Type': 'application/json' },
        ...
        async savePage() {
            ...
            try {
                const res = await fetch('/api/data-crud/pages/' + this.currentPageSc, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
        ...
        previewPage() {
            ...
            window.open('/data-crud/sub-systems/' + this.subSystemSc + '/portal', '_blank');
        },
        ...
        async togglePublish() {
            ...
            try {
                const res = await fetch('/api/data-crud/projects/' + this.subSystemSc + '/' + action, {
                    method: 'POST',
                });
                const data = await res.json();
                if (data.success) {
