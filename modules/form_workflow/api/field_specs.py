...
def _ensure_models():
    ...
    if FwFormFieldSpec is None:
        from ..models import FwFormFieldSpec as _S, FwFormFieldSpecHistory as _H
        FwFormFieldSpec = _S
...
def get_sql_schema(form_template_sc):
    ...
    try:
        from ..services.sql_sync.schema_reader import read_table_columns
...
def alter_plan(form_template_sc):
    ...
    try:
        from ..services.sql_sync.alter_manager import compute_alter_plan
...
def alter_execute(form_template_sc):
    ...
    try:
        from ..services.sql_sync.alter_manager import compute_alter_plan, execute_alter_plan
        plan = compute_alter_plan(
            registry.column_mapping,
            spec.fields,
            org.secure_code,
...
def full_status(form_template_sc):
    ...
    _ensure_models()
    from ..models import FwFormTemplate, FwSqlFormRegistry
    ...
    if template:
        ...
        from ..services.field_spec.drift_detector import _extract_formio_fields
    ...
    if spec and template:
        from ..services.field_spec.drift_detector import compare_spec_vs_formio
    ...
    if spec and registry:
        from ..services.field_spec.drift_detector import compare_spec_vs_sql
    ...
    if template and registry:
        from ..services.field_spec.drift_detector import compare_formio_vs_sql
