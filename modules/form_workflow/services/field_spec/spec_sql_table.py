...
def list_org_tables(org_sc):
    ...
    """
    from ..sql_sync.schema_reader import list_tables
...
def ensure_org_db(org_sc, org_id):
    ...
    """
    from ..sql_sync.org_db_manager import get_org_database, provision_org_database
...
def spec_fields_to_columns(spec_fields):
    ...
    """
    from ..sql_sync.converter import FORMIO_TO_PG
...
def _read_existing_columns(org_sc, table_name):
    ...
    """
    from ..sql_sync.schema_reader import read_table_columns
...
def apply_spec_to_sql(org_sc, table_name, spec_fields, confirm=False):
    ...
    """
    from ..sql_sync.table_manager import table_exists, validate_design_table_name
    from ..sql_sync.converter import build_create_table_sql, build_create_table_ddl_text
    from ..sql_sync.pool import get_org_conn
