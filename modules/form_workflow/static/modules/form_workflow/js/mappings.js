...
function mappingsManager() {
    return {
        ...
        async loadMappings() {
            this.loading = true;
            try {
                const res = await fetch(window.__BP + '/api/mappings/');
        ...
        async loadArchivedMappings() {
            try {
                const res = await fetch(window.__BP + '/api/mappings/?is_archived=true');
                const data = await res.json();
                if (data.success) {
        ...
        async loadUnmappedForms() {
            try {
                const res = await fetch(window.__BP + '/api/mappings/unmapped-forms');
                const data = await res.json();
                if (data.success) {
        ...
        async loadWorkflows() {
            try {
                const res = await fetch(window.__BP + '/api/mappings/workflows-for-mapping');
                const data = await res.json();
                if (data.success) {
        ...
        async publishMapping(m) {
            ...
            try {
                const res = await fetch(`${window.__BP}/api/mappings/${m.secure_code}/publish`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' }
                });
                const data = await res.json();
        ...
        async viewPublished(m) {
            ...
            try {
                const res = await fetch(`${window.__BP}/api/mappings/published?mapping_secure_code=${m.secure_code}`);
                const data = await res.json();
                if (data.success) {
        ...
        async suspendVersion(v) {
            try {
                const res = await fetch(`${window.__BP}/api/mappings/published/${v.secure_code}/suspend`, {
                    method: 'POST'
                });
                const data = await res.json();
                if (data.success) {
        ...
        async reopenVersion(v) {
            try {
                const res = await fetch(`${window.__BP}/api/mappings/published/${v.secure_code}/reopen`, {
                    method: 'POST'
                });
                const data = await res.json();
                if (data.success) {
        ...
        async archiveMapping(m) {
            ...
            try {
                const res = await fetch(`${window.__BP}/api/mappings/${m.secure_code}/archive`, {
                    method: 'POST'
                });
                const data = await res.json();
                if (data.success) {
        ...
        async unarchiveMapping(a) {
            try {
                const res = await fetch(`${window.__BP}/api/mappings/${a.secure_code}/unarchive`, {
                    method: 'POST'
                });
                const data = await res.json();
                if (data.success) {
        ...
        async deleteVersion(v) {
            ...
            try {
                const res = await fetch(`${window.__BP}/api/mappings/published/${v.secure_code}`, {
                    method: 'DELETE'
                });
                const data = await res.json();
                if (data.success) {
        ...
        async deleteMapping() {
            ...
            try {
                const res = await fetch(`${window.__BP}/api/mappings/${this.deletingMapping.secure_code}`, {
                    method: 'DELETE'
                });
                const data = await res.json();
        ...
        async toggleSqlSync(v, enabled) {
            ...
            try {
                const res = await fetch(`${window.__BP}/api/mappings/published/${v.secure_code}/sql-sync`, {
                    method: 'PATCH',
                    headers: { 'Content-Type': 'application/json' },
        ...
        async loadSyncStatus(v) {
            try {
                const res = await fetch(`${window.__BP}/api/mappings/published/${v.secure_code}/sql-sync/status`);
                const data = await res.json();
        ...
        async loadNumberingRules() {
            try {
                const res = await fetch(window.__BP + '/api/mappings/numbering-rules');
                const data = await res.json();
                if (data.success) {
        ...
        async updateNumberingRule(m, ruleSecureCode) {
            try {
                const res = await fetch(`${window.__BP}/api/mappings/${m.secure_code}`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
        ...
        async _loadPermCounts() {
            for (const m of this.mappings) {
                try {
                    const res = await fetch(`${window.__BP}/api/mapping-permissions/${m.secure_code}`);
                    const data = await res.json();
                    if (data.success) {
        ...
        async _loadPermRules(mappingSc) {
            try {
                const res = await fetch(`${window.__BP}/api/mapping-permissions/${mappingSc}`);
                const data = await res.json();
                if (data.success) {
        ...
        async addPermRule() {
            ...
            try {
                const res = await fetch(`${window.__BP}/api/mapping-permissions/${this.permMapping.secure_code}`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
