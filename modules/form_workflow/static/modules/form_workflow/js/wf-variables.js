 ...
 */
        ...
        async function loadMappedForms(versionType = 'design') {
            ...
            try {
                const response = await fetch(`${window.__BP}/api/workflows/data/templates/${currentWorkflowId}/mapped-forms?version_type=${versionType}`);
        ...
        async function loadVariableMapping() {
            ...
            try {
                ...
                const response = await fetch(window.__BP + '/api/workflows/data/variable-mapping', {
                    method: 'POST',
        ...
        async function loadFormFields(form) {
            ...
            try {
                ...
                const formIdentifier = form.form_secure_code || form.form_id;
                let url = `${window.__BP}/api/workflows/data/forms/${formIdentifier}/fields?version_type=${currentVersionType}`;
                if (form.mapping_id) {
        ...
        async function onVarConfigFormChange(mode) {
            ...
            try {
                ...
                let url = `${window.__BP}/api/workflows/data/forms/${formId}/fields?version_type=${currentVersionType}`;
