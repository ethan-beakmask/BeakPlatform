...
function lookupManager() {
    ...
    return {
        ...
        async saveCategory() {
            ...
            try {
                ...
                if (this.catForm.secure_code) {
                    url = window.__BP + '/api/lookup/categories/' + this.catForm.secure_code;
                    method = 'PUT';
                } else {
                    url = window.__BP + '/api/lookup/categories';
                    method = 'POST';
                }
                var body = {
        ...
        async loadItems() {
            ...
            try {
                var res = await fetch(window.__BP + '/api/lookup/categories/' + this.selectedCat.secure_code + '/items');
                var data = await res.json();
                if (data.success) {
        ...
        async _persistOrder() {
            ...
            try {
                var res = await fetch(
                    window.__BP + '/api/lookup/categories/' + this.selectedCat.secure_code + '/items/reorder',
                    {
                        method: 'PATCH',
                        headers: { 'Content-Type': 'application/json' },
        ...
        async saveItem() {
            ...
            try {
                ...
                if (this.itemForm.secure_code) {
                    url = window.__BP + '/api/lookup/items/' + this.itemForm.secure_code;
                    method = 'PUT';
                } else {
                    url = window.__BP + '/api/lookup/categories/' + this.selectedCat.secure_code + '/items';
                    method = 'POST';
                }
                var body = {
