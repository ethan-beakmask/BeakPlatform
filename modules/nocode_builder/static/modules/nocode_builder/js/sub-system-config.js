...
function subSystemConfigManager() {
    return {
        ...
        async loadSubSystem() {
            try {
                const res = await fetch(window.__BP + '/api/nocode-builder/sub-systems/' + this.secureCode);
        ...
        async loadPolicies() {
            try {
                const res = await fetch(
                    window.__BP + '/api/nocode-builder/sub-systems/' + this.secureCode + '/permission-policies'
                );
                const data = await res.json();
                if (data.success) {
        ...
        async savePolicy() {
            ...
            try {
                const url = window.__BP + '/api/nocode-builder/sub-systems/' + this.secureCode
