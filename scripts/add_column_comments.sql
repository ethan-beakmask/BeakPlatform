...
COMMENT ON COLUMN conglomerates.shared_db_host IS '共享資料庫主機';
COMMENT ON COLUMN conglomerates.shared_db_port IS '共享資料庫連接埠';
COMMENT ON COLUMN conglomerates.shared_db_name IS '共享資料庫名稱';
COMMENT ON COLUMN conglomerates.shared_db_user IS '共享資料庫使用者';
COMMENT ON COLUMN conglomerates.shared_db_password_encrypted IS '共享資料庫密碼 (加密)';
COMMENT ON COLUMN conglomerates.has_shared_db IS '是否已設定共享資料庫';
