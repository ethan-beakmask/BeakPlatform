...
Ethan 親自點名的批次，原話：「例如 OsExecutor 可以簡單的執行 ls -al 或取得系統時間
...
（fw_categories.secure_code='J1ygL6zexauKlLM0_Ktoaw'）。系統企業已對 OsExecutor
...
def main():
    parser = argparse.ArgumentParser(
        description='佈建 node展覽館的 OsExecutor 示範（B6）')
