...
USAGE = """用法:
  scripts/seed_smtp_test_config.py --orgs DEMOSOC,ACME --dry-run
  scripts/seed_smtp_test_config.py --orgs DEMOSOC,ACME --apply
  scripts/seed_smtp_test_config.py --orgs DEMOSOC,ACME --apply --source-name "yourbot@example.com"
  scripts/seed_smtp_test_config.py --orgs DEMOSOC,ACME --apply --no-default
...
def _build_parser():
    ...
    parser.add_argument(
        '--orgs',
        required=True,
        help='逗號分隔的企業 code，例如 DEMOSOC,ACME',
    )
